                        ...
                        <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                          if($MyTrans = $AdminTask->Get_User_Payment_History($Auth->email,$Auth->admin_role)){
                            $sn=0;
                          foreach ($MyTrans as $MyTran) {
                            ...
                            ?>
                                            <tr>
                                              <td><?= $sn ?></td>
                                    <td><a href="#" style="color: #003366"><?= $MyTran->request_id ?></a></td>
                                    <td>N<?= $MyTran->amount ?></td>
                                    <td><?= is_numeric($MyTran->product_name) ? 'Cheap Data' : strtoupper($MyTran->product_name); ?></td>
                                    <td><?= strtoupper($MyTran->unique_element) ?></td>
                                    
                                    <td><?php
                                     if($MyTran->status == 1){?>
                                     <span class="badge light badge-success">Successful</span>
                                      <?php
                                        }elseif ($MyTran->status == 2) {
                                      ?>
                                    <span class='badge light badge-danger'><?= $MyTran->response_description ?></span>
