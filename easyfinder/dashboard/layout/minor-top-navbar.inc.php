...
<?php
// Full referral URL — includes SITE_URL so links work from any page
$referral_full_url = rtrim(SITE_URL, '/') . '/easyfinder/dashboard/register?join_with_referal=' . $Auth->referal_token;
?>
<p id="p1" style="display: none;"><?= htmlspecialchars($referral_full_url) ?></p>
