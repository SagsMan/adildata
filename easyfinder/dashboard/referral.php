...
$conn_r = mysqli_connect('localhost', 'adiliqgs_adildata', 'adildata2026', 'adiliqgs_adildata');
$emailSafe  = mysqli_real_escape_string($conn_r, $Auth->email);
$myToken    = $Auth->referal_token; // MD5 of email, stored in users_tbl
...
// Referred users (users who used my referral token)
$referred_rows = [];
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-success mr-2" onclick="copyRefLink()"
                        ...
                        <a href="https://wa.me/?text=<?= urlencode('Join me on ' . SITE_TITLE . ' to buy cheap data! Use my referral link: ' . $referral_url) ?>"
                           target="_blank"
                           class="btn btn-success mr-2" style="background:#25D366;border-color:#25D366;">
